...
<%
	...
	ResultSet rs_sale = conn
			.executeQuery("select top 12 t1.ID, t1.GoodsName,t1.price,t1.nowPrice,t1.picture,t2.TypeName "
											...
											<div>
												<div class="image">
													<a href="goodsDetail.jsp?ID=<%=hot_ID%>"><img
														src="../images/goods/<%=hot_picture%>" width="250px">
													</a>
												</div>
												<div class="name">
